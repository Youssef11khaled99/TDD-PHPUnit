...
class GildedRoseTest extends TestCase
{
    ...
    {
        $item = GildedRoseEnhanced::of('normal', 10, 5); // quality, sell in X days
    ...
    {
        $item = GildedRoseEnhanced::of('normal', 10, 0);
    ...
    {
        $item = GildedRoseEnhanced::of('normal', 10, -5);
    ...
    {
        $item = GildedRoseEnhanced::of('normal', 0, 5);
    ...
    {
        $item = GildedRoseEnhanced::of('Aged Brie', 10, 5);
    ...
    {
        $item = GildedRoseEnhanced::of('Aged Brie', 50, 5);
    ...
    {
        $item = GildedRoseEnhanced::of('Aged Brie', 10, 0);
    ...
    {
        $item = GildedRoseEnhanced::of('Aged Brie', 49, 0);
    ...
    {
        $item = GildedRoseEnhanced::of('Aged Brie', 50, 0);
    ...
    {
        $item = GildedRoseEnhanced::of('Aged Brie', 10, -10);
    ...
    {
        $item = GildedRoseEnhanced::of('Aged Brie', 50, -10);
    ...
    {
        $item = GildedRoseEnhanced::of('Sulfuras, Hand of Ragnaros', 10, 5);
    ...
    {
        $item = GildedRoseEnhanced::of('Sulfuras, Hand of Ragnaros', 10, -1);
...
//    {
//        $item = GildedRoseEnhanced::of('Conjured Mana Cake', 10, 10);
//
//        $item->tick();
//
//        $this->assertEquals(8, $item->quality);
...
//    {
//        $item = GildedRoseEnhanced::of('Conjured Mana Cake', 0, 10);
//
//        $item->tick();
//
//        $this->assertEquals(0, $item->quality);
...
//    {
//        $item = GildedRoseEnhanced::of('Conjured Mana Cake', 10, 0);
//
//        $item->tick();
//
...
//    {
//        $item = GildedRoseEnhanced::of('Conjured Mana Cake', 0, 0);
//
//        $item->tick();
//
//        $this->assertEquals(0, $item->quality);
